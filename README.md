...
I'm Nolan! I'm a :telescope: physicist :sparkles: by training, but I've pivoted to :computer: computer science :floppy_disk: as a career. I hack on machine learning to "improve" digital advertising :mega:.

When I'm not using my mathematical skill to build an all-seeing advertising AI, I'm probably trying to wrap my head around a physics equation :chart_with_upwards_trend:, power through a mathematical theory, code my way out of a tough spot, or speed through Calgary on my bicycle :bike:.
...
### ➕ What I'm Working On ➕
 ...
 - :bicyclist: [Cycling Tracker (Rider)](https://github.com/NolantheNerd/Rider) :bar_chart:
